...
// Well what's this you ask? This knocks out the assert.h provided by NuttX,
// which would otherwise redefine the ASSERT macro in oslmic.h. I don't want
// the NuttX version of the macro as it restarts the whole board in case
// e.g. the radio chip is unavailable. I only want the lora task to exit.
